        ...
        <div>
            <section className='md:mt-[3vw] mt-[6vw] px-[2vw] md:px-[8vw]'>
                <div className='flex justify-between items-center mb-[3vw] md:mb-[0.7vw]'>
                    ...
                    <Link to='/' className='flex gap-1 md:gap-2 items-center text-Primary font-Poppins text-[4vw] md:text-[1.2vw]'>View All <BsArrowRight className='text-[4vw] md:text-[1.2vw]'/></Link>
                </div>
