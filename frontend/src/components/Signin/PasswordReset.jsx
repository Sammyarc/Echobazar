                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="relative mt-[1vw]">
                                <input
                                    ...
                                    value={email}
                                    className='w-full outline-none border border-Gray300 px-[2.5vw] py-[3vw] md:px-[1vw] md:py-[0.8vw] rounded-[1.5vw] md:rounded-[0.5vw] font-Poppins pr-[9vw] focus:border-Primary'
