                ...
                <div
                    ...
                    <div
                        ...
                        <div className="relative w-full md:w-auto">
                            <input
                                type="email"
                                className="w-[95vw] md:w-[30vw] py-[3vw] px-[2.5vw] md:py-3 md:px-4 pr-[35vw] md:pr-[10vw] text-Gray900 text-[4vw] md:text-[1vw] rounded-lg md:rounded-full border border-Gray200 outline-none placeholder:font-Poppins placeholder:text-Gray500 focus:border-Primary"
